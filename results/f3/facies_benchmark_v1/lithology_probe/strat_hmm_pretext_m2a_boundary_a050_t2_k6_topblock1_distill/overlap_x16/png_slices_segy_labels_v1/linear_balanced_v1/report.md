...
- MODEL_TAG: strat_hmm_pretext_m2a_boundary_a050_t2_k6_topblock1_distill
- checkpoint path: 未確認
...
|---:|---|---:|---:|---:|
| 0 | Upper North Sea | 0.9824 | 0.9655 | 1226 |
| 1 | Middle North Sea | 0.9384 | 0.8840 | 803 |
| 2 | Lower North Sea | 0.9344 | 0.8769 | 3909 |
| 3 | Rijnland/Chalk | 0.5416 | 0.3714 | 354 |
| 4 | Scruff | 0.7803 | 0.6398 | 665 |
| 5 | Zechstein | 0.3926 | 0.2443 | 46 |

- confusion matrix:

```text
[[1203, 22, 0, 0, 1, 0], [12, 762, 27, 0, 2, 0], [8, 37, 3492, 222, 135, 15], [0, 0, 14, 231, 66, 43], [0, 0, 32, 43, 563, 27], [0, 0, 0, 3, 11, 32]]
```
...
- weighted F1は0.9052で、頻出classの性能を確認できる。
- balanced accuracyは0.8364で、class imbalanceを考慮した比較指標になる。

### 失敗しているclass

- class 5 Zechstein: F1=0.3926, IoU=0.2443
- class 3 Rijnland/Chalk: F1=0.5416, IoU=0.3714
