...
- weighted F1は0.8962で、頻出classの性能を確認できる。
- balanced accuracyは0.8416で、class imbalanceを考慮した比較指標になる。

### 失敗しているclass

- class 5 Zechstein: F1=0.3911, IoU=0.2431
- class 3 Rijnland/Chalk: F1=0.5489, IoU=0.3782
