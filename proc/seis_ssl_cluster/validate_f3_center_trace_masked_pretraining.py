...
def build_parser() -> argparse.ArgumentParser:
	"""Build the strict experiment-104 validator CLI parser."""
	parser = argparse.ArgumentParser(
		description='Validate F3 center-trace masked schema-7 pretraining.'
	)
...
def main() -> int:
	...
	result = validate_f3_center_trace_masked_pretraining(
		load_f3_center_trace_masked_pretraining_validation_config(args.config),
		phase=args.phase,
