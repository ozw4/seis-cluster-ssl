"""Validate and publish the F3 XY-neighbour consensus pretraining handoff."""
...
def build_parser() -> argparse.ArgumentParser:
	"""Build the standalone XY-neighbour consensus validator parser."""
	parser = argparse.ArgumentParser(
		description='Validate F3 XY-neighbour consensus hard-label pretraining.'
	)
...
def main() -> int:
	...
	result = validate_f3_xy_neighbor_consensus_pretraining(
		load_f3_xy_neighbor_consensus_pretraining_validation_config(args.config),
		phase=args.phase,
