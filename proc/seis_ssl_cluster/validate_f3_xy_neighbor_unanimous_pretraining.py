"""Validate and publish the F3 unanimous XY-neighbour pretraining handoff."""
...
def build_parser() -> argparse.ArgumentParser:
	"""Build the strict standalone unanimous pretraining validator parser."""
	parser = argparse.ArgumentParser(
		description='Validate F3 unanimous XY-neighbour hard-label pretraining.'
	)
...
def main() -> int:
	"""Run the requested immutable successor validation phase."""
	args = build_parser().parse_args()
	result = validate_f3_xy_neighbor_unanimous_pretraining(
		load_f3_xy_neighbor_unanimous_pretraining_validation_config(args.config),
		phase=args.phase,
