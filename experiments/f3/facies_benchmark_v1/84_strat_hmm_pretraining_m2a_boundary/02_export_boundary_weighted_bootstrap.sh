...
python proc/seis_ssl_cluster/export_strat_hmm_pseudo_targets.py \
  ...
  --pseudo-target-root /workspace/artifacts/seis_ssl_cluster/pseudo_targets/f3/facies_benchmark_v1/strat_hmm_k6_pca64_resid_token_phase_edge8_expected3_iter10_bootstrap_boundary_a050_t2 \
  --k 6 \
  --confidence 1.0 \
  --boundary-alpha 0.5 \
  --boundary-tau 2.0 \
