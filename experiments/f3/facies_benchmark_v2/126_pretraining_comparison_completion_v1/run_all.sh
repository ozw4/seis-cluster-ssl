...
for arm in "${arms[@]}"; do
	...
	if [[ ! -f "$SEIS_SSL_CLUSTER_ARTIFACT_ROOT/f3_lithology_benchmark/pretraining_comparison_completion_v1/summary/$arm/summary.json" ]]; then
		run_stage "${arm}_summarize_f3_lithology_candidate" \
