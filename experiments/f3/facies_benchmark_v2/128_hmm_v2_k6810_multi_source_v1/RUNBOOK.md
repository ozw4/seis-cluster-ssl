...
Run `bash experiments/f3/facies_benchmark_v2/128_hmm_v2_k6810_multi_source_v1/run_all.sh --plan` to review commands. The default is plan.
...
`hmm_v2/k6810_multi_source_evaluation_v1/f3/logs` in the artifact root.
