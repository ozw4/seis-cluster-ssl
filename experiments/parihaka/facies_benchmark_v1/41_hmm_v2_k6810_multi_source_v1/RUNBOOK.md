...
Run `bash experiments/parihaka/facies_benchmark_v1/41_hmm_v2_k6810_multi_source_v1/run_all.sh --plan` to review commands. The default is plan.
...
`hmm_v2/k6810_multi_source_evaluation_v1/parihaka/logs` in the artifact root.
