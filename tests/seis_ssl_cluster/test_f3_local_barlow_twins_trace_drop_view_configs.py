"""Training and embedding config contracts for F3 trace-drop experiment 112."""
...
BASE_CONFIG = ROOT / '10_stage1/horizontal_trace_drop_p001_base1ep/01_screen_1ep.yaml'
CONTINUATION_CONFIG = (
	ROOT / '15_stage2/horizontal_trace_drop_p001_base1ep/01_continue_25ep.yaml'
)
EXTRACTION_CONFIG = (
...
def test_base_changes_only_augmentation_and_namespace() -> None:
	parent = load_config(
		GAUSSIAN_BASE1 / '10_stage1/gaussian_noise_std010_base1ep/01_screen_1ep.yaml'
	)
...
def test_continuation_uses_the_base_checkpoint_and_fixed_budget() -> None:
	parent = load_config(
		GAUSSIAN_BASE1 / '15_stage2/gaussian_noise_std010_base1ep/01_continue_25ep.yaml'
	)
...
def test_embedding_uses_the_continuation_checkpoint() -> None:
	parent = load_config(
		GAUSSIAN_BASE1 / '20_embeddings/01_extract_gaussian_noise_std010_base1ep.yaml'
	)
