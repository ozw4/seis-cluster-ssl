...
- MODEL_TAG: strat_hmm_m1_guardrail_distill_only
- checkpoint path: 未確認
...
|---:|---|---:|---:|---:|
| 0 | Upper North Sea | 0.9645 | 0.9315 | 1226 |
| 1 | Middle North Sea | 0.9317 | 0.8721 | 803 |
| 2 | Lower North Sea | 0.9270 | 0.8640 | 3909 |
| 3 | Rijnland/Chalk | 0.5321 | 0.3625 | 354 |
| 4 | Scruff | 0.7660 | 0.6208 | 665 |
| 5 | Zechstein | 0.3978 | 0.2483 | 46 |

- confusion matrix:

```text
[[1183, 27, 7, 1, 8, 0], [13, 764, 25, 0, 1, 0], [30, 46, 3442, 221, 148, 22], [1, 0, 13, 228, 63, 49], [0, 0, 30, 52, 555, 28], [0, 0, 0, 1, 9, 36]]
```
...
- weighted F1は0.8954で、頻出classの性能を確認できる。
- balanced accuracyは0.8430で、class imbalanceを考慮した比較指標になる。

### 失敗しているclass

- class 5 Zechstein: F1=0.3978, IoU=0.2483
- class 3 Rijnland/Chalk: F1=0.5321, IoU=0.3625
